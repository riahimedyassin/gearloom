    ...
    tasks: [
      {
        ...
        subtasks: [
          { 
            ...
            createdBy: { id: 2, firstname: "Sarah", lastname: "Wilson", email: "sarah.wilson@example.com" },
        ...
        attachments: [
          {
            ...
            uploadedBy: { id: 1, firstname: "John", lastname: "Doe", email: "john@example.com" },
          },
          {
            id: 2,
    ...
    tasks: [
      {
        ...
        attachments: [
          {
            ...
            description: "User authentication flow documentation",
            url: "https://example.com/auth-flow",
            resourceType: "document" as const,
            uploadedAt: "2024-01-02T10:00:00Z",
            uploadedBy: { id: 2, firstname: "Jane", lastname: "Smith", email: "jane@example.com" },
          },
        ],
        steps: [
          {
        ...
        pomodoroTimer: {
          id: 2,
          taskId: 2,
          totalTimeSpent: 75, // 75 minutes total - task currently in progress
          sessions: [
            {
              id: 4,
              type: "work" as const,
            ...
            },
            {
              ...
              type: "work" as const,
              duration: 25,
              timeRemaining: 420, // 7 minutes left - currently active!
    ...
    tasks: [
      {
        ...
        subtasks: [
          { 
            ...
            createdBy: { id: 3, firstname: "Mike", lastname: "Brown", email: "mike.brown@example.com" },
            assignedTo: { id: 3, firstname: "Mike", lastname: "Brown", email: "mike.brown@example.com" },
...
export default function KanbanPage() {
  ...
  const [activeTimerTaskId, setActiveTimerTaskId] = useState<number | null>(
    mockColumns.flatMap(col => col.tasks).find(task => task.pomodoroTimer.isActive)?.id || null
  );
